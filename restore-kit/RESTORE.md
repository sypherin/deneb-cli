...
```bash
mkdir -p ~/bin
curl -fsSL https://raw.githubusercontent.com/sypherin/deneb-cli/main/restore-kit/spark-stack-guard.sh -o ~/bin/spark-stack-guard.sh
chmod +x ~/bin/spark-stack-guard.sh
curl -fsSL https://raw.githubusercontent.com/sypherin/deneb-cli/main/restore-kit/spark-stack-guard.service -o ~/.config/systemd/user/spark-stack-guard.service
curl -fsSL https://raw.githubusercontent.com/sypherin/deneb-cli/main/restore-kit/spark-stack-guard.timer -o ~/.config/systemd/user/spark-stack-guard.timer
...
curl -fsSL https://raw.githubusercontent.com/sypherin/deneb-cli/main/restore-kit/gateway.ts -o ~/llm-gateway/gateway.ts
